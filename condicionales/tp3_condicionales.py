...
print('*** Mayor o menor de edad***') #Ajustado al requerimiento, sin contemplar otras edades
...
'''    
print('*** Sistema de números pares ***')
...
print('*** Sistema de categorías por edad ***')
...
contrasenia = input('Ingrese la constraseña: ')
...
print('*** Sistema de estadisticas ***')

numeros_aleatorios = [random.randint(1, 100) for i in range(50)]
print(f'La lista de némeros generada es {numeros_aleatorios}')
...
print('*** Sistema para jugar con palabras ***')
palabra = input('Ingrese la palabra o frase que escogió: ')
...
print('*** Medidor de intensidad de terremotos ***')
magnitud = float(input('Ingrese la magnitud del terremoto: '))
if magnitud < 3:
    print('Muy leve (Imperceptible)')
elif magnitud >= 3 and magnitud < 4:
    print('Leve (Ligeramente imprceptible)')
...
print('*** Programa para conocer la estacion del año ***')
hemisferio = input('¿En qué hemisferio se encuentra(N/S)?')
hemisferio = hemisferio.lower()
mes = int(input('Indique el mes(1-12): '))
dia = int(input('Indique que día es: '))
...
#hemisferio sur
    ...
    if (mes == 'diciembre' and dia >= 21) or \
        ...
        print("Otoño")
            ...
            (mes == 'septiembre' and dia <= 20):
        print("Invierno")
    else: # De lo contrario, es primavera
        print("Primavera")
